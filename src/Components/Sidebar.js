...
const Sidebar = () => {
  ...
  return (
    <div className="flex">
      ...
      <div
        className={`
          fixed top-0 left-0 h-full bg-gray-900 text-white p-5
      ...
      {/* Main content area */}
      <div className="flex-1 ml-0 sm:ml-64 p-5">
        <h1 className="text-3xl font-bold">Main Content</h1>
        <p className="mt-4">
          This is the main content area. Resize the window to see the responsive behavior of the sidebar.
        </p>
      </div>
    </div>
  );
...
//         <button
//             onClick={toggleSidebar}
//             className="md:hidden p-2 m-2 bg-blue-500 text-white rounded-full
//             focus:outline-none"
//             >
...
//             } md:block fixed inset-y-0 left-0 z-10 flex-shrink-0 border-r overflow-y-auto
//             bg-gradient-to-r from-navy_blue to-dark_blue dark:border-indigo-800 dark:bg-darker
//             md:w-60`}
//             >
//             <nav className="flex flex-col items-center flex-1 p-4">
//                 <div className="flex-shrink-0 mb-4">
//                     <a
//                         href="https://kamona-wd.github.io/kwd-dashboard/"
//                         className="text-xl font-bold tracking-wider text-blue_picton uppercase
//                         dark:text-light">
//                         K-WD
//                     </a>
//                 </div>
...
//                     <Link to='/'>
//                         <button className="p-2 text-blue_picton transition-colors duration-200 rounded-full bg-indigo-50 hover:text-slate-200 hover:bg-indigo-100 dark:hover:bg-sky-600 dark:bg-dark focus:outline-none">

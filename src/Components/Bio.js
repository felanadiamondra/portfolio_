...
//             <div className="flex flex-grow h-72 break-normal bg-slate-200 rounded-md mx-20 ml-40 p-10 justify-center shadow-xl backdrop-filter backdrop-blur-sm bg-opacity-10 border border-gray-100">
//                 <img className="z-50 w-50 h-50 rounded-full mr-20 sm:w-25 sm:h-25" src={profil} alt="Felana Diamondra RANDRIAMADISON"/>
//                 <div className=''>
//                     <blockquote>
...
const Bio = (props) => {
    ...
    return (
    <div className='my-12 px-6 sm:my-16 sm:px-8 md:my-24 md:px-10 lg:my-28'>
        <p className='text-transparent bg-clip-text bg-gradient-to-r from-dark_blue
        to-blue_picton font-bold text-center text-lg sm:text-xl md:text-2xl'>
        ...
        backdrop-blur-sm bg-opacity-10 border border-gray-100">
            <img className="w-24 h-24 sm:w-36 sm:h-36 md:w-50 md:h-50 rounded-full
            ...
            <div className='text-center md:text-left'>
                ...
                <figcaption className="font-medium text-slate-300 opacity-95 mt-4 md:mt-0">
                    <div className="animate__animated animate__fadeInUp">Diamondra
                    RANDRIAMADISON</div>
                    <div className="animate__animated animate__fadeInUp">{t("Developer")}</div>
                </figcaption>
            </div>
